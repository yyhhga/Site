...
const optionalStyles =
   'data-[active]:bg-neutral-100/50 dark:data-[active]:bg-neutral-800/50 focus:bg-blue-400 focus:text-neutral-900 focus:outline-none'

const navigationMenuTriggerStyle = cva(
   'group inline-flex h-10 w-max items-center justify-center rounded-md bg-inherit px-4 py-2 text-lg font-semibold transition-colors hover:bg-blue-400 hover:text-neutral-900 disabled:pointer-events-none disabled:opacity-50  data-[state=open]:bg-neutral-100/50 dark:bg-neutral-950 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[state=open]:bg-neutral-800/50',
)
